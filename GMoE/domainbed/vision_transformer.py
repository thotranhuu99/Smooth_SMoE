...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0., drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm, cur_depth=0, moe_layers=None, num_experts=6, router='cosine_top', index_hook=False, is_tutel=False, topk=1):
        super().__init__()
        ...
        if self.cur_layer == 'S':
            ...
            self.mlp = tutel_moe.moe_layer(
                gate_type={'type': router, 'k': topk, 'fp32_gate': True, 'gate_noise': 1.0, 'capacity_factor': 1.5},
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', moe_layers=None, num_experts=6, index_hook=False, router='cosine_top', topk=1, **kwargs):
        """
        Args:
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                cur_depth=i, moe_layers=moe_layers, num_experts=num_experts, index_hook=index_hook, router=router, topk=topk)
