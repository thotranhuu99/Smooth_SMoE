...
def parse_args():
    ...
    parser.add_argument("--seeds", type=int, default=[0, 2, 4], nargs="+", help="seeds for reproducible training.")
    ...
    parser.add_argument('--gate_type', type=str, default='top', choices=['top', 'cosine_top', 'gated_multi_gate', 'gated_multi_gate_t', 'smooth_top'])
...
def main(args, seed=0, lr=3e-5):
    ...
    if args.task_name is not None:
        ...
        metric = evaluate.load("/root//DynMoE-2/EMoE/Language/dataset/glue/metrics.py", args.task_name)
    else:
